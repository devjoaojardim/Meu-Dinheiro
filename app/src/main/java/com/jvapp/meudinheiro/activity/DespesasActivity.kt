...
class DespesasActivity : AppCompatActivity() {
    ...
    fun validarCampoDespesa(): Boolean {
        ...
        return if (!textoValor.isEmpty()) {
            if (!textoData.isEmpty()) {
                if (!textoCategoria.isEmpty()) {
                    if (!textoDescricao.isEmpty()) {
                        ...
                        Toast.makeText(
                            this@DespesasActivity, "Preencha a Descrição da Despesa",
                            Toast.LENGTH_LONG
                        ).show()
                        false
                    }
                    ...
                    Toast.makeText(
                        this@DespesasActivity, "Preencha a Categoria da Despesa",
                        Toast.LENGTH_LONG
                    ).show()
                    false
                }
                ...
                Toast.makeText(
                    this@DespesasActivity, "Preencha a Data da Despesa",
                    Toast.LENGTH_LONG
                ).show()
                false
            }
            ...
            Toast.makeText(
                this@DespesasActivity, "Preencha o valor da Despesa",
                Toast.LENGTH_LONG
            ).show()
            false
        }
